...
export type ISearchUsersPayload = IPaginatedSearchRequest<
  IUsersSearchFormFields
>;
...
export type IResetSearchResults = IPlainAction<
  'USERS_SEARCH:RESET_SEARCH_RESULTS'
>;

export type ISearchUsers = IAction<
  'USERS_SEARCH:SEARCH_USERS',
  ISearchUsersPayload
>;
export type ISearchUsersSuccess = IAction<
  'USERS_SEARCH:SEARCH_USERS_SUCCESS',
  ISearchUsersSuccessPayload
>;
export type ISearchUsersFail = IPlainFailAction<
  'USERS_SEARCH:SEARCH_USERS_FAIL'
>;

export type ILoadUserDetails = IAction<
  'USERS_SEARCH:LOAD_USER_DETAILS',
  number
>;
export type ILoadUserDetailsSuccess = IAction<
  'USERS_SEARCH:LOAD_USER_DETAILS_SUCCESS',
  IDetailedGithubUser
>;
export type ILoadUserDetailsFail = IPlainFailAction<
