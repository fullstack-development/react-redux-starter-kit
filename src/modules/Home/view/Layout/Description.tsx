  ...
  return (
    <div>
      ...
      <p className={s[b('description')()]}>
        ...
        <Label bsStyle="primary" className={s[b('tool')()]}>TypeScript 2.x</Label>
        <Label bsStyle="primary" className={s[b('tool')()]}>React</Label>
        <Label bsStyle="primary" className={s[b('tool')()]}>Redux</Label>
        <Label bsStyle="primary" className={s[b('tool')()]}>Stylus</Label>
        <Label bsStyle="primary" className={s[b('tool')()]}>Bem</Label>
        <Label bsStyle="primary" className={s[b('tool')()]}>Webpack 2.x</Label>
      </p>
      <p className={s[b('description')()]}>
