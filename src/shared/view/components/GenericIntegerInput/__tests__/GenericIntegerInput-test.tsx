...
import GenericIntegerInput, { IState, IProps } from './../GenericIntegerInput';
import InputGroup from './../../../elements/InputGroup/InputGroup';

describe('(Shared) View', () => {
  describe('(Component) GenericIntegerInput', () => {

    it('should render GenericIntegerInput', () => {
      const component = mount(<GenericIntegerInput minimum={1}  maximum={1} />);
    ...
    it('should set error when value less minimal value', () => {
      const onChangeSpy = spy();
    ...
    it('should set error when value more maximal value', () => {
      const onChangeSpy = spy();
